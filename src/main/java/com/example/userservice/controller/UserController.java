...
public class UserController {
	...
	public ResponseEntity<User> updateUser(@PathVariable Integer uid, @RequestBody User user){
		return new ResponseEntity<User>(userService.updateUser(uid, user), HttpStatus.OK);
	}
